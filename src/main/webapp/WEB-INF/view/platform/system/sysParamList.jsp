...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="com.cosim.platform.model.system.SysParam"%>
...
<body>
			<div class="panel">
				...
				<div class="panel-body">
						...
						<cosim:paging tableId="sysParamItem"/>
