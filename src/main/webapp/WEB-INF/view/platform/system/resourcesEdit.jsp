						...
						<tr>
							...
							<td>
								<select id="isHidden" name="isHidden">
									<option value="0" <c:if test="${resources.isHidden==0}">selected="selected"</c:if>>否</option>
									<option value="1" <c:if test="${resources.isHidden==1}">selected="selected"</c:if>>是</option>
								</select>
							</td>
						</tr>
