...
<script type="text/javascript">
	$(function() {
		$("#resetAll").click(function(){
			...
			var ele=this;
			$.ligerMessageBox.confirm('提示信息','确认重置所有状态吗？',function(rtn){
				if(rtn){
					if(ele.click){
						$(ele).unbind('click');
						ele.click();
...
// 			var ele = this;
// 			$.ligerMessageBox.confirm('提示信息','确认开启吗？',function(rtn) {
// 				if(rtn) {
// 					if(ele.click) {
// 						$(ele).unbind('click');
// 						ele.click();
	...
	<div class="panel">
		<div class="panel-top">
			<div class="panel-toolbar">
				<div class="toolBar">
					<a class="link update" id="resetAll" href="resetAll.ht">重置所有监控信息</a>
				</div>
			</div>
		</div>
