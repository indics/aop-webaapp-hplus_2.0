...
<head>
	...
	<script>
		function readMsg(messageId){
			var url = '${ctx}/platform/system/messageRead/read.ht?messageId=' + messageId;
			$.ajax({
				type : 'post',
				dataType : 'json',
				async : false,
				...
				success : function(obj) { 
					if (obj.result==1) {//读取
						location.href='${ctx}/b2b/pub/message/message/get.ht?id=' + messageId;
					} else {
			...
			<div class="panel">
				<div class="panel-top">
					...
					<div class="panel-search">
							<form id="searchForm" method="post" action="notReadMsg.ht">
									<div class="row">
...
<!-- 									    </select> -->
				...
				<div class="panel-body">
					    ...
					    <display:table name="messageReceiverList" id="messageReceiverItem" requestURI="notReadMsg.ht" sort="external" cellpadding="1" cellspacing="1"   class="table-grid">
							<display:column title="${checkAll}" media="html" style="width:30px;">
								  	<input type="checkbox" class="pk" name="id" value="${messageReceiverItem.id}">
							</display:column>
							...
							<display:column title="管理" media="html" style="width:180px">
								...
								<a href="javascript:readMsg(${messageReceiverItem.id});" class="link detail">明细</a>
							</display:column>
						</display:table>
