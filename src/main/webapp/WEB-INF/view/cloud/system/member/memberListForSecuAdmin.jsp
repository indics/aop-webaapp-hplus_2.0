	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="listForSecuAdmin.ht">
					<div class="row">
		...
		<div class="panel-body">
		    ...
		    <display:table name="infoList" id="infoItem" requestURI="listForSecuAdmin.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
