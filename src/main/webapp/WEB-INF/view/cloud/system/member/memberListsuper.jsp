	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="listAllnew.ht">
					<div class="row">
		...
		<div class="panel-body">
		    ...
		    <display:table name="factoryInfoList" id="factoryInfoItem" requestURI="listAllnew.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
