...
<body>
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a class="link" onclick="toWsh()">置为未审核</a></div>
				</div>	
			</div>
			<div class="panel-search">
				<form id="searchForm" method="post" action="listYsh.ht">
					<div class="row">
		...
		<div class="panel-body">
		    ...
		    <display:table name="factoryInfoList" id="factoryInfoItem" requestURI="listYsh.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
				...
				<display:column title="管理" media="html">
					...
					<a href="${ctx}/b2b/operation/auth/user/list.ht?sysOrgInfoId=${factoryInfoItem.sysOrgInfoId}" class="link detail">人员</a>
					<a href="${ctx}/b2b/operation/auth/org/list.ht?sysOrgInfoId=${factoryInfoItem.sysOrgInfoId}" class="link detail">组织</a>
					<a href="${ctx}/cloud/saas/position/tree.ht?sysOrgInfoId=${factoryInfoItem.sysOrgInfoId}" class="link detail">岗位</a>
					<a href="${ctx}/platform/bpm/bpmDefinition/manage.ht?sysOrgInfoId=${factoryInfoItem.sysOrgInfoId}" class="link detail">流程</a>
				</display:column>
			</display:table>
