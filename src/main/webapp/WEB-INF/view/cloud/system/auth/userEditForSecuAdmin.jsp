...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/tree/v35/jquery.ztree.core-3.5.js"></script>
...
// 					rootPId: -1
	...
	function loadrolTree() {
		var setting = {       				    					
			...
			var url="${ctx}/platform/system/sysRole/getTreeData.ht?tenantId=${sysOrgInfoId}";
...
<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				...
				<c:if test="${sysUser.userId!=null }">编辑${sysUser.fullname}用户角色信息</c:if>  
				</span>
			</div>
	   ...
	   <form id="sysUserForm" method="post" action="saveForSecuAdmin.ht?sysOrgInfoId=${sysOrgInfoId}" style="position:absolute;">
            <div  id="tabMyInfo" class="panel-nav" style="overflow:hidden; position:relative;display: none;">
