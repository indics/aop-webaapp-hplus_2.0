...
<body>
	...
	<div class="panel-toolbar" id="pToolbar"
		...
		<div class="toolBar">
			<c:if test="${canReturn=='0'}">
				<div class="group">
					<a class="link edit"
						href="edit.ht?userId=${sysUser.userId}&bySelf=1">编辑</a>
				</div>
			</c:if>
			<c:if test="${canReturn!='0'}">
				<div class="group">
	...
	<div id="tabMyInfo" style="overflow: hidden; position: relative;">
		...
		<div title="基本信息" tabid="userdetail"
			...
			<div class="panel-detail">
				<table class="table-detail" cellpadding="0" cellspacing="0"
					border="0" style="margin-top: 8px/9; _margin: 30px 0 0 0;">
					<tr>
		...
		<div title="所属组织" tabid="orgdetail" icon="${ctx}/styles/default/images/resicon/home.png">
			<div style="overflow-y: auto; overflow-x: hidden; border: 0px solid #6F8DC6;">
				<div class="panel-data">
				    <table cellspacing="1" cellpadding="1" class="table-grid table-list" id="orgItem">
				    <thead>
				        <tr>
				            <th>组织名称</th>
				            <th>是否主组织</th>
		...
		<div title="所属角色" tabid="roldetail" icon="${ctx}/styles/default/images/resicon/customer.png">
			<div style="overflow-y: auto; overflow-x: hidden; border: 0px solid #6F8DC6;">
				<div class="panel-data">
					 <table cellspacing="1" cellpadding="1" class="table-grid table-list" id="rolItem">
				    <thead>
				        <tr>
				            <th>角色名称</th>
				            <th>子系统名称</th>
