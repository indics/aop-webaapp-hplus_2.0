...
<head>	
	...
	$(function() {
		...
		$("#importMarket").click(function() {
			...
			$("#importMarket").attr({"disabled":"disabled"});
			frm.submit();
		});
...
<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label">人员信息导入</span>
			</div>
		</div>
		<div class="panel-body">
			<form id="f1" action="${ctx}/b2b/operation/auth/user/importUser.ht" method="post" enctype="multipart/form-data">
				<table class="table-grid">
					...
					<tr>
						...
						<td style="text-align:left; width: 82%;padding-left:10px;">
							<input  style="padding:0px 5px;" type="button" type="button" id="importMarket" value="导入" />
							<input  style="margin-left:10px; padding:0px 5px;" type="button" onclick="javascript:window.history.go(-1)" value="返回"/>
							<a style="margin-left:30px;" href="${ctx}/template/b2b/人员信息_模版.xls">模板下载</a>
						</td>
					</tr>
				</table>
			</form>
