...
<head>
   ...
   <script type="text/javascript" src="${ctx}/js/cloud/system/CloudFlexUploadDialog.js"></script>
	...
	function addPic(){
		CloudFlexUploadDialog({isSingle:true,callback:picCallBack});
	};
            ...
            <div  id="tabMyInfo" class="panel-nav" style="overflow:hidden; position:relative;">  
	           <div title="基本信息" tabid="userdetail" icon="${ctx}/styles/default/images/resicon/user.gif">
			           		...
			           		<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
								    <th>编   码: </th>
									<td ><input type="text" id="code" name="code" value="${sysUser.code}"  style="width:240px !important" class="inputText"/></td>
								</tr>
								
								<tr>
								    <th>参考编码: </th>
									<td ><input type="text" id="refCode" name="refCode" value="${sysUser.refCode}"  style="width:240px !important" class="inputText"/></td>
								</tr>
								<tr>
									<th>用户性别: </th>
									<td>
