...
<script type="text/javascript">
	function dlgCallBack(userIds, fullnames) {
		if (userIds.length > 0) {
			...
			form.creatForm("form", "${ctx}/cloud/saas/userRole/add.ht");
		...
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group">
						<a class="link back"
							href="${ctx }/cloud/saas/role/listByTenant.ht">返回</a>
					</div>
				</div>
			</div>
		...
		<div class="panel-body">
			...
			<display:table name="userRoleList" id="userRoleItem"
				...
				<display:column title="${checkAll}" media="html" style="width:30px;">
					<input type="checkbox" class="pk" name="userRoleId" value="${userRoleItem.saasUserRoleid}">
				</display:column>
				...
				<display:column title="管理" media="html" style="width:180px">
					<a href="del.ht?saasUserRoleid=${userRoleItem.saasUserRoleid}" class="link del">删除</a>
				</display:column>
			</display:table>
