...
<body>
	<div class="panel">
		...
		<div class="panel-body">
		    ...
		    <display:table name="saasRoleList" id="saasRoleItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
				...
				<display:column title="管理" media="html" style="width:180px">
					<a href="del.ht?saasroleresid=${saasRoleItem.saasRoleId}" class="link del">删除</a>
					<a href="edit.ht?saasroleresid=${saasRoleItem.saasRoleId}" class="link edit">编辑</a>
					<a href="get.ht?saasroleresid=${saasRoleItem.saasRoleId}" class="link detail">明细</a>
