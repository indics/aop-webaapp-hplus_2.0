...
<html>
<head>
<title>企业系统管理员查看日志</title>
<%@include file="/commons/include/get.jsp"%>
<script type="text/javascript">
	//弹出导出日志窗口
	var quote_window = null;
	function exportAudits() {
		var urlShow = '${ctx}/cloud/system/audit/log/exportForTenantSystemAdminInfo.ht';
...
<body>
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a class="link" href="javaScript:exportAudits()">导出日志</a></div>
				</div>	
			</div>
			<div class="panel-search">
				<form id="searchForm" method="post" action="listForSystemAdmin.ht">
					<div class="row">
						...
						<span class="label">会员名称:</span><input type="text" name="Q_tenantName_SL"  class="inputText" />
					</div>
				</form>
			</div>
		</div>
		<div class="panel-body">
		    ...
		    <display:table name="sysAuditList" id="sys_auditItem" requestURI="listForSystemAdmin.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
				...
				<display:column property="tenantName" title="会员名称" sortable="true" sortName="tenantName" maxLength="80"></display:column>
				...
				<display:column property="requestURI" title="请求URL" sortable="true" sortName="requestURI" maxLength="80"></display:column>
				 --%>
				<display:column property="reqParams" title="操作内容" sortable="false" sortName="reqParams" maxLength="80"></display:column>
				<display:column property="resultState" title="状态" sortable="true" sortName="resultState" maxLength="80"></display:column>
