...
<script type="text/javascript">
           ...
           //生成树      		
       	   function loadTree(selid){
	       		var setting = {
						...
						async: {
							enable: true,
							url:"${ctx}//cloud/config/enterprise/org/system/sysOrg/getTreeData.ht?demId="+selid,
        	...
        	function sortType(orgIds){
        		$.post("${ctx}//cloud/config/enterprise/org/system/sysOrg/sort.ht?orgIds="+orgIds,
        			function(result){
        	...
        	*/
        	...
        	function onDrop(event, treeId, treeNodes, targetNode, moveType) {
        		...
        		var url=__ctx + "//cloud/config/enterprise/org/system/sysOrg/move.ht";
