...
<body>
	<div class="panel-toolbar" id="pToolbar">
		<div class="toolBar">
			...
			<div class="group">
				<!-- <a class="link back" href="javascript:history.back();">3445返回</a> -->
			</div>
		</div>
	</div>
					...
					<tr>
						<td rowspan="12" align="center" width="26%">
							...
							<%-- 	<p><img src="${ctx}/${pictureLoad}" alt="个人相片" onError="this.src='${ctx}/${pictureLoad}'"/></p> --%>
								<p><img src="${fileCtx}/${pictureLoad}" alt="个人相片" onError="this.src='${ctx}/${pictureLoad}'" width="230px;" height="370px;"/></p>
							</div>
						</td>
