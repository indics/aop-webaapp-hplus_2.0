...
<head>	
	...
	<script>
		...
		function showResponse(responseText) {			
			...
			dd.close();
			if (obj.isSuccess()) {
				$.ligerMessageBox.alert("提示信息",obj.getMessage(),"success",function(rtn){
...
<body>
	<div class="panel">
		...
		<div class="panel-body">
			<form id="importForm" action="import.ht" method="post" enctype="multipart/form-data">
			<table class="table-grid">
				...
				<tr>
					...
					<td style="text-align:left; padding-left:10px;">
						...
						<a style="margin-left:20px; font-weight:bold;" href="${ctx}/template/XXEnterprise-personnel information import table.xls" id="template">模板下载</a>
					</td>
				</tr>
				<tr>
