...
<html lang="zh-cn">
    <head>
        ...
        <link rel="stylesheet" href="${ctx}/static/assets/css/activities-serverload.css" />
        <!-- ace styles -->
		...
		<script type="text/javascript">
			if ('ontouchstart' in document.documentElement)
				document.write("<script src='${ctx}/static/assets/js/jquery.mobile.custom.js'>" + "<"+"/script>");
		</script>
	...
	<div class="col-xs-12">
		...
		<div class="alert alert-block alert-success">
			...
			<strong class="green">
   			...
   			<br>
   			本演示采用了Iframe布局的方式，没有完全按照ACE的流式布局，想要了解ACE
   			<a href="${contextPath}/static/examples/index.html" target="_blank">点此进入ACE演示地址</a>
   			&nbsp<a href="http://www.iteblog.com/ace" target="_blank">官网ACE地址</a>
		</div>
