...
(function ($)
{
    ...
    $.ligerui.controls.ComboBox.ligerExtend($.ligerui.controls.Input, {
        ...
        createIframe:function(selectBox){
        	...
        	iframeObj.css({left:selectBox.left,top:selectBox.top,width:selectBox.width()+2,height:p.selectBoxWidth+5})
        ...
        showIframe:function(selectBox){
        	...
        	obj.show();
        	obj.css({ top: selectBox.css("top"), left: selectBox.css("left") , width: selectBox.width()+2,height:p.selectBoxWidth+5 });  
