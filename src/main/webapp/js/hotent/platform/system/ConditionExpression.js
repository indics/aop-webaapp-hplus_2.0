Namespace.register("com.cosim.platform.system");
/**
 * 表达式计算。
 * var con=com.cosim.platform.system.ConditionExpression();
 * 计算节点
 * con.evaluate(node);
 * 获取结果
 * con.getResult();
 * 清除计算
 * con.clear();
 * @returns {com.cosim.platform.system.ConditionExpression}
 */
com.cosim.platform.system.ConditionExpression = function(){
	{
